  ...
  const renderStep3 = () => (
    <Animated.View entering={FadeInRight} style={styles.stepContent}>
      ...
      <GlassCard
        ...
        style={[styles.numberOption, selectedNumber === "existing" ? styles.numberOptionActive : null]}
      >
      ...
      <GlassCard
        ...
        style={[styles.numberOption, selectedNumber === "new" ? styles.numberOptionActive : null]}
      >
